...
toflow help                   # Show help
toflow view                   # Open TUI

# Track Commands
toflow create track <name> [<description>]        # Create a track
toflow delete track <id>                          # Delete a track
toflow list tracks                                # List all tracks (default: (id, name))
todo track <id>                                 # View track details
toflow rename track <id> <new_name>               # Rename a track
toflow update track --description <description>   # Update track description
toflow activate track <id>                        # Activate a track
toflow sleep track <id>                           # Sleep a track
toflow archive track <id>                         # Archive a track
toflow unarchive track <id>                       # Unarchive a track

# Project Commands
toflow create project <name> in <track_id> [<description>]    # Create a project in a track
toflow delete project <id>                                # Delete a project
toflow list projects in <track_id>                         # List all projects in a track
todo project <id>                                       # View project details
toflow rename project <id> <new_name>                      # Rename a project
toflow update project --description <description>          # Update project properties
                    --deadline <deadline>
                    --willingness_hint <willingness_hint>
                    --importance_hint <importance_hint>
                    --urgency_hint <urgency_hint>
toflow activate project <id>                               # Activate a project
todo focus project <id>                                  # Focus a project
toflow sleep project <id>                                  # Sleep a project
toflow cancel project <id>                                 # Cancel a project
todo finish project <id>                                 # Finish a project
toflow archive project <id>                                # Archive a project
toflow unarchive project <id>                              # Unarchive a project

# Todo Commands
toflow create todo <name> in <project_id> [<description>]    # Create a todo in a project
toflow delete todo <id>                                      # Delete a todo
toflow list todos in <project_id>                             # List all todos in a project
toflow todo <id>                                              # View todo details
toflow rename todo <id> <new_name>                             # Rename a todo
toflow update todo --description <description>                 # Update todo properties
                 --url <url>
                 --deadline <deadline>
toflow activate todo <id>                                   # Activate a todo
toflow done todo <id>                                        # Done a todo
toflow cancel todo <id>                                      # Cancel a todo
toflow archive todo <id>                                      # Archive a todo
toflow unarchive todo <id>                                    # Unarchive a todo


# Box Commands
toflow create box todo <name> [<description>]     # Create a box todo
toflow delete box todo <id>                       # Delete a box todo
toflow list box todos                             # List all box todos
toflow box todo <id>                              # View box todo details
toflow rename box todo <id> <new_name>            # Rename a box todo
toflow update box todo --description <description>    # Update box todo properties
                     --url <url>
                     --deadline <deadline>
toflow activate box todo <id>                       # Activate a box todo
toflow done box todo <id>                            # Done a box todo
toflow cancel box todo <id>                          # Cancel a box todo
toflow archive box todo <id>                          # Archive a box todo
toflow unarchive box todo <id>                        # Unarchive a box todo

toflow create idea <name> [<description>]    # Create a idea
toflow delete idea <id>                      # Delete a idea
toflow list ideas                             # List all ideas
toflow idea <id>                              # View idea details
toflow rename idea <id> <new_name>            # Rename a idea
toflow update idea --description <description> # Update idea properties
                    --maturity_hint <maturity_hint>
                    --willingness_hint <willingness_hint>
toflow activate idea <id>                       # Activate a idea
toflow sleep idea <id>                          # Sleep a idea
todo deprecate idea <id>                      # Deprecate a idea
toflow promote idea <id> to <track_id>          # Promote a idea to a track
toflow archive idea <id>                         # Archive a idea
toflow unarchive idea <id>                       # Unarchive a idea

# Now Session Commands
# No real-time timer for CLI currently
toflow save session <project_id> <todo_id> <duration_minutes> <started_at_utc> <ended_at_utc> [--description <description>] # Save a session and record description
toflow delete session <id>                          # Delete a session
toflow list sessions                                # List all sessions
toflow session <id>                                  # View session details
...
使用 uv 进行依赖管理，pyproject.toml 配置 `[project.scripts]` 使 `toflow` 命令可用。
